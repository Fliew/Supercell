 ...
 * 
 * @subpackage	FLTemplate
 * @link		http://www.smarty.net/documentation
 */

class FLTemplate implements FLTemplateInterface
{
	/**
	 * @access	public
	 * @var		mixed
	...
	public function __construct()
	{
		...
		$template_config	=	new FLConfig('template');
		$cache_config		=	new FLConfig('cache');
		
		// Get smarty libs
		require_once(SERVER_PATH . '/system/libraries/FLTemplate/drivers/smarty/Smarty.class.php');
